...
class QueryAnalyzer:
    ...
    def _detect_intent(question: str):
        ...
        if (
            ...
            re.search(
                r"\b(write|create|generate|develop|implement|code|program|"
                r"wap|write\s+a\s+program)\b",
                question,
            )

            # Programming-related phrases
            or any(
                phrase in question
                for phrase in [
                    "write code",
            ...
            # Programming artifact keywords
            or (
                re.search(
                    r"\b(code|program|script|function|class|method|"
                    r"algorithm|implementation)\b",
                    question,
                )
                and re.search(
                    r"\b(write|create|generate|implement|develop|"
                    r"wap|using|in)\b",
                    question,
                )
            )
