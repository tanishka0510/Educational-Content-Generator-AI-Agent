...
# ==========================================================
# Ambiguous / Cross-Subject Keywords
# ==========================================================
...
def detect_question_subject(
    ...
    Ambiguous/cross-subject keywords such as:
        array, class, object, tree, graph, algorithm
    are not strong enough by themselves to determine the subject.
    ...
    for subject, keywords in SUBJECT_KEYWORDS.items():
        ...
        for keyword in keywords:
            ...
            # Ambiguous keywords
            # --------------------------------------------------
            # These concepts occur across multiple subjects.
            # They should not strongly classify a question.
            # --------------------------------------------------

            if keyword_lower in AMBIGUOUS_KEYWORDS:
                continue
    ...
    # ----------------------------------------------------------
    # No subject-specific keyword found
    # ----------------------------------------------------------
    ...
    # ----------------------------------------------------------
    # Find all subjects having the highest score
    # ----------------------------------------------------------
    ...
    # ----------------------------------------------------------
    # If multiple subjects have the same score,
    # don't claim a confident subject.
    # ----------------------------------------------------------

    if len(top_subjects) > 1:
        return "Unknown", 0

    return top_subjects[0], highest_score
...
def validate_question_subject(
    ...
    Important:
    Generic or cross-subject technical concepts should NOT
    automatically cause rejection.
    ...
    # ------------------------------------------------------
    # Case 1:
    # No strong subject-specific keyword was found.
    #
    # Example:
    #   "explain array declaration"
    #
    # "array" is ambiguous, so don't reject OOP.
    # ------------------------------------------------------
    ...
    # ------------------------------------------------------
    # Case 3:
    # Strong evidence indicates another subject.
    #
    # Example:
    #
    # Selected: OOP
    # Question: explain deadlock and process scheduling
    #
    # Detected: OS
    #
    # This can legitimately be rejected.
    # ------------------------------------------------------
